## summary function
#' summary function for PSO_design, PSO_power,PSOGO_Design, PSOGO_power, PSO_design_dual,PSO_power_dual, PSOGO_design_dual, PSOGO_power_dual, PSO_design_TE, PSOGO_design_TE
#'
#' @param object PSO_design, PSO_power,PSOGO_Design, PSOGO_power, PSO_design_dual,PSO_power_dual, PSOGO_design_dual, PSOGO_power_dual, PSO_design_TE, PSOGO_design_TE PSO_power_TE
...
summary.gbop2 <- function(object, ...) {
  ...
  ########## PSOGO_design_dual ########################################
  if (object$`function` == "PSOGO_design_dual") {
    # Extract relevant fields from object
    design <- object$design
    weight <- object$weight
    method <- object$method
  ...
  ########## PSOGO_power_dual ########################################
  if (object$`function` == "PSOGO_power_dual") {
    # Extract relevant fields from object
    design <- object$design
    method <- object$method
    parameters <- object[grepl("parameter", names(object))]
