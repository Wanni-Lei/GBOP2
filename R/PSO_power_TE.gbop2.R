...
PSO_power_TE <- function(design = "optimal",
  ...
  objf <- function(x, inputlist) {
    ...
    r1 = inputlist$e1a
    t1 = inputlist$e2a
    temp_pe = .Call("_GBOP2_exact_error_recursive2_Rcpp", interm.eff, bound_eff, r0, r1, 5)
    temp_pt = .Call("_GBOP2_exact_error_recursive2_Rcpp", interm.tox, interm-bound_tox, 1-t0, 1-t1, 5)
